...
Route::get("/musei/create-musei", [PublicController::class, "create_musei"])->name("create_musei");
Route::post("/museo/add", [PublicController::class, "add_museo"])->name("add_museo");
Route::get("/museo/detail/{museo}", [PublicController::class, "showMuseo"])->name("museo_show");
Route::get("/musei/edit/{museo}", [PublicController::class, "editMuseo"])->name("museo_edit");
Route::put("/museo/update/{museo}", [PublicController::class, "updateMuseo"])->name("museo_update");
Route::delete("/museo/destroy/{museo}", [PublicController::class, "destroyMuseo"])->name("museo_destroy");
